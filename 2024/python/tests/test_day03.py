...
def test_sample_part1():
    testing_utils.run_part_test(DAY, part=1, input_text=TEST_INPUT_PART_1, expected=161)


def test_sample_part2():
    testing_utils.run_part_test(DAY, part=2, input_text=TEST_INPUT_PART_2, expected=48)
